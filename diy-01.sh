...
svn co https://github.com/xiaorouji/openwrt-passwall/trunk/luci/luci-app-passwall openwrt-passwall/luci-app-passwall
# git clone https://github.com/xiaorouji/openwrt-passwall2.git package/passwall2
#git clone -b luci https://github.com/xiaorouji/openwrt-passwall openwrt-passwall
